...
function buildLearnedMappings(confirmedTransactions) {
    const mappings = new Map();
    for (const tx of confirmedTransactions){
        // Only learn from confirmed transactions that are not uncategorized
        if (tx.status === "confirmed" && tx.category !== "Uncategorized") {
            const normalized = normalizeTransactionName(tx.name);
            // Only set if not already in mappings (first occurrence wins)
...
function Home() {
    ...
    const handleImport = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])((rawRows)=>{
        ...
        const mapped = rawRows.map((row)=>{
            ...
            const category = autoCategorize(name, amount);
            return {
                date: date,
                name: name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__09edb562._.js.map