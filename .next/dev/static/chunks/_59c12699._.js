...
;
;
function DropZone({ onModelsImported }) {
    _s();
    ...
    const handleDragOver = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DropZone.useCallback[handleDragOver]": (e)=>{
            e.preventDefault();
            setIsDragging(true);
        }
    }["DropZone.useCallback[handleDragOver]"], []);
    const handleDragLeave = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DropZone.useCallback[handleDragLeave]": (e)=>{
            e.preventDefault();
            setIsDragging(false);
        }
    }["DropZone.useCallback[handleDragLeave]"], []);
    const handleDrop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DropZone.useCallback[handleDrop]": (e)=>{
            e.preventDefault();
            setIsDragging(false);
            const files = Array.from(e.dataTransfer.files);
            console.log("Dropped files:", files.map({
                "DropZone.useCallback[handleDrop]": (f)=>`${f.name} (${f.type})`
            }["DropZone.useCallback[handleDrop]"]));
            const csvFile = files.find({
                "DropZone.useCallback[handleDrop].csvFile": (f)=>f.type === "text/csv" || f.name.toLowerCase().endsWith(".csv") || f.type === "application/vnd.ms-excel" // Common for CSVs on Windows/macOS
            }["DropZone.useCallback[handleDrop].csvFile"]);
            if (csvFile) {
                setIsProcessing(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$papaparse$2f$papaparse$2e$min$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].parse(csvFile, {
                    header: true,
                    skipEmptyLines: true,
                    complete: {
                        "DropZone.useCallback[handleDrop]": (results)=>{
                            console.log("Parsed CSV Results:", results);
                            if (results.errors.length > 0) {
                                console.error("Papaparse Errors:", results.errors);
                            }
                            onModelsImported(results.data);
                            setIsProcessing(false);
                        }
                    }["DropZone.useCallback[handleDrop]"],
                    error: {
                        "DropZone.useCallback[handleDrop]": (error)=>{
                ...
                console.warn("No CSV file found in drop");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        onDrop: handleDrop,
        className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("border-2 border-dashed rounded-lg p-12 text-center transition-colors cursor-pointer", isDragging ? "border-blue-500 bg-blue-50" : "border-gray-300 hover:border-gray-400", isProcessing && "opacity-50 cursor-wait"),
        children: isProcessing ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(DropZone, "5bniH48t+F8MiqRsoQ3r728PU88=");
_c = DropZone;
var _c;
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                                    type: "number",
                                                    step: "0.01",
                                                    className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$clsx$2f$dist$2f$clsx$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])("w-full bg-transparent p-3 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-500 text-right font-mono text-sm border-transparent", tx.amount < 0 ? "text-red-600" : "text-emerald-700 font-medium"),
                                                    value: tx.amount,
...
function Home() {
    ...
    const handleImport = (rawRows)=>{
        ...
        const mapped = rawRows.map((row)=>{
            ...
            // Simple logic: if 'debit' exists and is positive, it might be negative amount? 
            // For now assume signed amounts or standard checks.
    ...
    const handleSave = async ()=>{
        try {
            const db = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDB"])();
            // Simple approach: Clear and re-insert or Up-sert. 
            // For now, let's just insert new ones (status pending -> confirmed would require id tracking)
            // But since we are editing a mixed list (db rows + new import), we need to handle this carefully.
            // Current simplified strategy: 
            // 1. Identify which ones are NEW (no ID). Insert them.
            // 2. Identify which ones are EXISTING (have ID). Update them.
            ...
            await loadTransactions(); // Reload to get IDs
...
_s(Home, "vhrN63ANTbxOxiASbNc1moOk59M=");
_c = Home;
var _c;
...
//# sourceMappingURL=_59c12699._.js.map