...
function MonthlyTrendChart({ transactions }) {
    ...
    const monthlyData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "MonthlyTrendChart.useMemo[monthlyData]": ()=>{
            // First try the last 6 months
            let data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMonthlyTotals"])(transactions, 6);
            // Check if there's any data in those months
            const hasData = data.some({
                "MonthlyTrendChart.useMemo[monthlyData].hasData": (m)=>m.income > 0 || m.expenses > 0
            }["MonthlyTrendChart.useMemo[monthlyData].hasData"]);
            ...
            if (!hasData && transactions.length > 0) {
                ...
                data = Array.from(monthMap.entries()).sort({
                    "MonthlyTrendChart.useMemo[monthlyData]": (a, b)=>a[0].localeCompare(b[0])
                }["MonthlyTrendChart.useMemo[monthlyData]"]).slice(-6) // Take last 6 months with data
                .map({
                    "MonthlyTrendChart.useMemo[monthlyData]": ([month, values])=>({
                            month,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        title: `Income: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(month.income)}`
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Dashboard.tsx",
                                        lineNumber: 180,
                                        columnNumber: 33
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        title: `Expenses: ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(month.expenses)}`
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Dashboard.tsx",
                                        lineNumber: 190,
                                        columnNumber: 33
...
_s(MonthlyTrendChart, "fW1Z/zdHCHgUu/WSTMnTw+TkV1U=");
_c1 = MonthlyTrendChart;
function CategoryBreakdownChart({ transactions }) {
    ...
    const categoryData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CategoryBreakdownChart.useMemo[categoryData]": ()=>{
            // First try current month
            let data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategoryGroupSpending"])(transactions);
            // If no data for current month, show all-time data
            if (data.length === 0) {
                const allExpenses = transactions.filter({
                    "CategoryBreakdownChart.useMemo[categoryData].allExpenses": (tx)=>tx.amount < 0
                }["CategoryBreakdownChart.useMemo[categoryData].allExpenses"]);
                const groupTotals = {};
                for (const tx of allExpenses){
                    const group = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getCategoryGroup"])(tx.category);
                    groupTotals[group] = (groupTotals[group] || 0) + Math.abs(tx.amount);
                }
                const totalExpenses = Object.values(groupTotals).reduce({
                    "CategoryBreakdownChart.useMemo[categoryData].totalExpenses": (sum, val)=>sum + val
                }["CategoryBreakdownChart.useMemo[categoryData].totalExpenses"], 0);
                data = Object.entries(groupTotals).map({
                    "CategoryBreakdownChart.useMemo[categoryData]": ([group, total])=>({
                            group,
                            total,
                            color: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GROUP_COLORS"][group] || "#94A3B8",
                            percentage: totalExpenses > 0 ? total / totalExpenses * 100 : 0
                        })
                }["CategoryBreakdownChart.useMemo[categoryData]"]).sort({
                    "CategoryBreakdownChart.useMemo[categoryData]": (a, b)=>b.total - a.total
                }["CategoryBreakdownChart.useMemo[categoryData]"]);
            }
            return data;
        }
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        ...
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(category.total)
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Dashboard.tsx",
                                        lineNumber: 287,
                                        columnNumber: 33
...
_s1(CategoryBreakdownChart, "823JfKNF+T052fLLA/7kee7OkkA=");
_c2 = CategoryBreakdownChart;
function YoYComparisonChart({ transactions }) {
    _s2();
    const yoyData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "YoYComparisonChart.useMemo[yoyData]": ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getYoYComparison"])(transactions)
    }["YoYComparisonChart.useMemo[yoyData]"], [
        transactions
    ]);
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(yoyData.previousTotal)
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Dashboard.tsx",
                                        lineNumber: 341,
                                        columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "text-sm font-semibold",
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPercentage"])(yoyData.change)
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Dashboard.tsx",
                                        lineNumber: 345,
                                        columnNumber: 25
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatCurrency"])(yoyData.currentTotal)
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/Dashboard.tsx",
                                        lineNumber: 349,
                                        columnNumber: 25
                    ...
                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: category.current > 0 || category.previous > 0 ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatPercentage"])(change) : '—'
                            }, void 0, false, {
                                fileName: "[project]/src/components/Dashboard.tsx",
                                lineNumber: 394,
                                columnNumber: 29
...
_s2(YoYComparisonChart, "9PIe9+aaFn2zHQN056zIx3C+25c=");
_c3 = YoYComparisonChart;
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(MonthlyTrendChart, {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(CategoryBreakdownChart, {
                            transactions: filteredTransactions
                        }, void 0, false, {
                            fileName: "[project]/src/components/Dashboard.tsx",
                            lineNumber: 473,
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(YoYComparisonChart, {
                    transactions: filteredTransactions
                }, void 0, false, {
                    fileName: "[project]/src/components/Dashboard.tsx",
                    lineNumber: 477,
...
_s3(Dashboard, "0Bi0Daht5dsX3CXkhBsKhY/BZjI=");
_c4 = Dashboard;
var _c, _c1, _c2, _c3, _c4;
__turbopack_context__.k.register(_c, "MetricCard");
__turbopack_context__.k.register(_c1, "MonthlyTrendChart");
__turbopack_context__.k.register(_c2, "CategoryBreakdownChart");
__turbopack_context__.k.register(_c3, "YoYComparisonChart");
...
//# sourceMappingURL=src_c5db1d0e._.js.map