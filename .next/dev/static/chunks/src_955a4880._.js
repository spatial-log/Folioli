...
"[project]/src/components/dashboard/YearOverYearChart.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ function getMonthlyExpenses(transactions, endYear, endMonth) {
    ...
    for(let i = 11; i >= 0; i--){
        ...
        const monthExpenses = transactions.filter((tx)=>{
            const txDate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDate"])(tx.date);
...
function YearOverYearChart({ transactions }) {
    ...
    const { minYear, maxYear, maxMonth } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "YearOverYearChart.useMemo": ()=>{
            let minYear = new Date().getFullYear();
            let maxYear = new Date().getFullYear();
            let maxMonth = new Date().getMonth();
            for (const tx of transactions){
                const date = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDate"])(tx.date);
                if (date) {
                    const year = date.getFullYear();
                    const month = date.getMonth();
    ...
    const [currentEndYear, setCurrentEndYear] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(maxYear);
    const [currentEndMonth, setCurrentEndMonth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(maxMonth);
    ...
    const chartData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "YearOverYearChart.useMemo[chartData]": ()=>{
            ...
            return currentPeriod.map({
                "YearOverYearChart.useMemo[chartData]": (current, index)=>({
                        label: current.label,
    ...
    const currentPeriodLabel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "YearOverYearChart.useMemo[currentPeriodLabel]": ()=>{
    ...
    const previousPeriodLabel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "YearOverYearChart.useMemo[previousPeriodLabel]": ()=>{
...
_s(YearOverYearChart, "W+k5dRo3KLF5/QD1N0c9o7yqEJ4=");
_c = YearOverYearChart;
var _c;
__turbopack_context__.k.register(_c, "YearOverYearChart");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/components/DebugDataView.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DebugDataView({ transactions }) {
    ...
    const debugInfo = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DebugDataView.useMemo[debugInfo]": ()=>{
            const total = transactions.length;
            const sample = transactions.slice(0, 10).map({
                "DebugDataView.useMemo[debugInfo].sample": (tx)=>({
                        id: tx.id,
                        rawDate: tx.date,
                        parsed: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDate"])(tx.date)?.toString() || "NULL",
                        amount: tx.amount,
                        category: tx.category
                    })
            }["DebugDataView.useMemo[debugInfo].sample"]);
            let minYear = 9999;
            let maxYear = 0;
            let validDates = 0;
            transactions.forEach({
                "DebugDataView.useMemo[debugInfo]": (tx)=>{
                    const d = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dashboardUtils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["parseDate"])(tx.date);
                    if (d) {
                        validDates++;
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                        children: debugInfo.sample.map((row, i)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
...
_s(DebugDataView, "ZTQQNVScKv94VDzXuuTTdOO9fro=");
_c = DebugDataView;
var _c;
__turbopack_context__.k.register(_c, "DebugDataView");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$YearOverYearChart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/dashboard/YearOverYearChart.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DebugDataView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/DebugDataView.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Dashboard({ transactions }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$DebugDataView$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["DebugDataView"], {
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "h-[450px]",
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$dashboard$2f$YearOverYearChart$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["YearOverYearChart"], {
                        transactions: filteredTransactions
                    }, void 0, false, {
                        fileName: "[project]/src/components/Dashboard.tsx",
                        lineNumber: 79,
...
//# sourceMappingURL=src_955a4880._.js.map