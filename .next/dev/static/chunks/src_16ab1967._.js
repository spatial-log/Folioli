        ...
        "Home.useCallback[handleImport]": (rawRows)=>{
            ...
            const mapped = rawRows.map({
                "Home.useCallback[handleImport].mapped": (row)=>{
                    ...
                    const category = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$categories$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["autoCategorize"])(name, amount);
                    return {
                        date: date,
                        name: name,
...
//# sourceMappingURL=src_16ab1967._.js.map